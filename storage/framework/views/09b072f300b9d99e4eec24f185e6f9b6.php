        ...
        try {
            ...
            data.forEach((payments, index) => {
                tableBody.insertAdjacentHTML('beforeend', `
                        ...
                        <td class="p-5 text-start text-sm  w-auto ">
                        ...
                        <td class="text-center">${payments.Status}</td>
                    </tr>
                `);
            });
        } catch (error) {
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\WebStudyIT\resources\views/user/transaction.blade.php ENDPATH**/ ?>