...
<body>
    ...
    <div class="container flex flex-row text-start  text-textColorLight">
            ...
            <div class="maincontent text-start mt-6 h-fit  gap-3 flex flex-col ">
                        ...
                        <div class="btn border-2 border-transparent py-3 hover:bg-textColorLight p-3 hover:text-hoverLight  hover:rounded-lg active:bg-activeLight ">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
                                ...
                                <a href="instructors">Transaction</a>
                            </li>
                        </div>
        ...
        <div class="content p-7 ml-60 w-full">
            <h1 class="text-textColorLight font-bold text-3xl"><?php echo $__env->yieldContent('content-title'); ?></h1>
...
<?php /**PATH D:\KULIAHAHAHHA\KULIAH\SEMESTER 5\WEB\laravel-frontend\resources\views/layouts/user.blade.php ENDPATH**/ ?>