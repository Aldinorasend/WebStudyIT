...
<div class="w-full flex flex-col">
    <div class="header w-full bg-gradient-to-r from-textColorLight to-activeLight h-auto -mt-11 gap-4 px-10 py-8 flex flex-row text-white justify-between">
        <!-- Left content -->
        <div class="content-body flex flex-col gap-4 justify-center">
            ...
            <p class="course-description text-gray-400 text-sm w-1/2">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Soluta pariatur porro tempore cupiditate cumque quas veniam commodi quo exercitationem!</p>
            <p class="text-sm text-sideBarLight">Course will end on <span class="end-date text-blue-600">30 Dec, 2025</span></p>
            <div class="rating flex flex-row gap-2 items-center">
                <p class="text-sm">Ratings: </p>
                <div class="flex flex-row gap-2">
                    <svg class="w-4 h-4 text-gray-300 cursor-pointer star" data-rating="1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alienware\Documents\WebPro\EXB\WebStudyIT\resources\views/user/courses.blade.php ENDPATH**/ ?>