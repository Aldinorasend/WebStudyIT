...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/style2FA.css')); ?>">
</head>
<body>
    <div class="twofa-container">
        ...
        <div class="button-container">
            <button class="button" onclick="window.location.href= '/enter-twoFactor'">Next</button>
        </div>
    </div>
    <script>
    async function fetch2FASecret() {
      try {
        const response = await fetch('http://localhost:3000/api/Accounts/enable-2fa', {
          ...
          body: JSON.stringify({ email: 'haritswot@gmail.com' }) // atau input manual
        });
...
</html><?php /**PATH C:\Users\harit\OneDrive\Documents\GitHub\WebStudyIT\resources\views/auth/twoFactor.blade.php ENDPATH**/ ?>